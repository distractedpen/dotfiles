...
local function enable_codelense(bufnr)
...
local function jdtls_on_attach(_, bufnr)
    ...
    vim.keymap.set('n', '<leader>em', "<cmd>lua require('jdtls').extract_method()<cr>", opts)
...
local function jdtls_setup()
    ...
    -- local class_path = vim.fn.readfile(data_dir .. '/.classpath', 1)
